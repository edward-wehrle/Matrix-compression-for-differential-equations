...
the typical multiplication process, many operations are wasted through trying to do multiplication with these zeros. By retaining location
and value data of the non-zero entries, and inputting the compressed matrix into an adapted solving algorithm, those wasted operations are 
...
science class, and represents my problem-solving abilities. It was one of my first coding projects, and represents the problem solving skills
I developed when learning mathematical modeling. 
